...
using BMP580_Type = BMP580_Base<float, double>;
...
static BMP580_Type bmp580(bmp580_i2c);
...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        res = bmp580.Init();
        if (!res) {
            bmp580.SetOversampling(BMP580_Type::Oversampling::X4, BMP580_Type::Oversampling::X4); // Set oversampling for pressure and temperature
    ...
    for (int i = 0; i < 10; ++i) {
        ...
        printf("Pressure: %.0f Pa, Temperature: %.3f °C, Altitude: %.3f m\n", real_data.pressure, real_data.temperature, real_data.GetAltitude(101702.0));
    }
